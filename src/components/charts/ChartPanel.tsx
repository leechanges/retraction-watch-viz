...
export default function ChartPanel({ title, icon, children, className = '', action }: ChartPanelProps) {
  return (
    <div className={`group relative bg-white/[0.03] hover:bg-white/[0.05] border border-white/[0.07] hover:border-white/[0.12] rounded-2xl p-5 transition-all duration-300 ${className}`}>
