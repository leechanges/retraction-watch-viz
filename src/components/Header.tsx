    ...
    >
      <div className="flex items-center gap-4">
        <div className="relative">
          <div 
            className="w-12 h-12 bg-gradient-to-br from-rose-500/20 to-blue-500/20 border border-white/10 rounded-2xl flex items-center justify-center backdrop-blur-sm shadow-lg shadow-rose-500/10"
            role="img"
            aria-label="学术诚信图标"
          >
            <AlertTriangle className="w-6 h-6 text-rose-400" aria-hidden="true" />
          </div>
          <div className="absolute -inset-1 bg-gradient-to-r from-rose-500/30 to-blue-500/30 rounded-2xl blur-sm -z-10" aria-hidden="true" />
        </div>
        <div>
