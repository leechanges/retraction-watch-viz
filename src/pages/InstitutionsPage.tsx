...
export const InstitutionsPage: React.FC = () => {
  ...
  return (
    <PageLayout icon="🏛" title="研究机构" subtitle={`共 ${institutionStats.length} 家机构`}>
        ...
        {institutionStats.slice(0, 50).map(([institution, count], i) => {
          ...
          return (
            ...
            >
              ...
              <span className="flex-1 font-medium text-slate-900 truncate" title={institution}>{institution}</span>
