    ...
    <div className="pt-14">
      <section className="hero-gradient py-20 px-6">
        <div className="max-w-7xl mx-auto text-center">
          ...
          <h1 className="headline-xl mb-6">出版商</h1>
      ...
      <section className="py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-3 gap-8 text-center mb-16">
            <div>
              <div className="stat-number text-[#1d1d1f]">{publisherStats.length}</div>
              <p className="text-[15px] text-[#86868b]">出版商数量</p>
            </div>
            <div>
            ...
            <div>
              <div className="stat-number text-[#0071e3]">{Math.round(records.length / publisherStats.length)}</div>
              <p className="text-[15px] text-[#86868b]">每出版商平均</p>
            </div>
          </div>

          <div className="space-y-4">
            {publisherStats.slice(0, 30).map(([publisher, count], i) => {
                ...
                >
                  <div className="flex items-center gap-6 mb-3">
                    ...
                    <div className="flex-1">
                      <div className="text-[21px] font-semibold">{publisher}</div>
                    </div>
